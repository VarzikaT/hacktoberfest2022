...
public:
    ...
    ListNode *oddEvenList(ListNode *head)
    {
        ...
        // This Pointer will Point to start of even numbers bcoz after traversing through 
        // LinkedList above two pointers will point to last correspoinding even and odd elements  
